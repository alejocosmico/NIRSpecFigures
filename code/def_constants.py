...
colorSet[16] = COLOR_SET[[1,3,6,7,10,11,12,18,19,20,21,24,25,27,28,29]].tolist()
colorSet[15] = COLOR_SET[[1,3,6,7,10,11,12,18,19,20,21,24,25,27,29]].tolist()
colorSet[14] = COLOR_SET[[1,3,6,7,11,12,18,19,20,21,24,25,27,29]].tolist()
colorSet[13] = COLOR_SET[[1,3,6,7,11,12,19,20,21,24,25,27,29]].tolist()
colorSet[12] = COLOR_SET[[1,3,6,7,11,12,19,20,21,25,27,29]].tolist() 
colorSet[11] = COLOR_SET[[1,3,6,11,12,19,20,21,25,27,29]].tolist()
colorSet[10] = COLOR_SET[[1,6,11,12,19,20,21,25,27,29]].tolist()
colorSet[9]  = COLOR_SET[[1,6,11,12,19,20,25,27,29]].tolist()
colorSet[8]  = COLOR_SET[[1,6,11,12,19,20,25,29]].tolist()
colorSet[7]  = COLOR_SET[[1,6,12,19,20,25,29]].tolist()
colorSet[6]  = COLOR_SET[[1,6,12,20,25,29]].tolist()
colorSet[5]  = COLOR_SET[[1,6,12,20,29]].tolist()
